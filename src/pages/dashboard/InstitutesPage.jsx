...
import { Plus, Search, Edit2, Trash2, Building2, UserPlus, CheckCircle, AlertCircle, Eye, EyeOff } from 'lucide-react'
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className={`absolute right-3 top-1/2 -translate-y-1/2 ${isDark ? 'text-gray-400 hover:text-gray-200' : 'text-gray-500 hover:text-gray-700'} transition-colors`}
                      tabIndex={-1}
                    >
